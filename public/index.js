...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConfirmationPage = __webpack_require__(202);
	var Form = __webpack_require__(262);
	var Confirmed = __webpack_require__(263);
	
	var connect = __webpack_require__(173).connect;
	var router = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getRestaurantSuccess = function getRestaurantSuccess(data) {
	  return {
	...
	var getRestaurantError = function getRestaurantError(err) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetch = __webpack_require__(169);
	...
	var userNotSaved = function userNotSaved() {
	  return {
	    type: USER_NOT_SAVED
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var combined = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var user = __webpack_require__(198).userReducer;
	var restaurant = __webpack_require__(201).restaurantReducer;
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'a',
	              { href: this.props.eatup.restaurant[0].url, target: '_blank', rel: 'noopener noreferrer' },
	              this.props.eatup.restaurant[0].url,
	              ' '
	            )
	          ),
	          React.createElement(
	            'li',
	            null,
	            this.props.eatup.restaurant[0].name
	          ),
	          restaurantAddress,
	          React.createElement(
	            'li',
	            null,
	            'Rating: ',
	            this.props.eatup.restaurant[0].rating
	          )
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'form',
	      { onSubmit: this.getRestaurant, className: 'restaurantSearch' },
	      React.createElement('input', { id: 'latitude', ref: 'latitude', hidden: 'true', type: 'text' }),
	      React.createElement('input', { id: 'longitude', ref: 'longitude', hidden: 'true', type: 'text' }),
	      React.createElement(
	        'div',
	        null,
	      ...
	      React.createElement(
	        'select',
	        { ref: 'foodType', id: 'foodType', className: 'foodTypeSelector' },
	        React.createElement(
	          'option',
	          { value: 'chinese' },
	          'Chinese'
